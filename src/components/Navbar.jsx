...
const Navbar = () => {
	...
	return (
		<div className=" border border-gray-600 rounded-lg bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center">
			<h1 className="text-3xl font-bold gradient-text ml-4">
				JAKE HARRIS
			</h1>
